...
public class InitiativeList extends TheBorg {
	...
	public List<Initiative> getInitiativeList(String initiativeStatus) {
		...
		try (Transaction tx = dch.graphDb.beginTx()) {
			//TODO retrieve the function ID as well
			...
			org.apache.log4j.Logger.getLogger(InitiativeList.class).debug("Executed query for retrieving initiative list with status " + initiativeStatus);
			while (res.hasNext()) {
